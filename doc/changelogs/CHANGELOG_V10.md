...
* **deps**: Upgrade V8 from 6.7 to 6.8 (Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
  * Memory reduction and performance improvements, details at: https://v8project.blogspot.com/2018/06/v8-release-68.html
* **fs**: Implement a `fs.mkdir()` recursive option, similar to the [mkdirp](http://ghub.io/mkdirp) npm package or `mkdir -p` on the command line (Benjamin Coe) [#21875](https://github.com/nodejs/node/pull/21875)
...
* [[`82830a809b`](https://github.com/nodejs/node/commit/82830a809b)] - **assert**: fix loose assert with map and set (Ruben Bridgewater) [#22145](https://github.com/nodejs/node/pull/22145)
...
* [[`01147b4637`](https://github.com/nodejs/node/commit/01147b4637)] - **build**: make --shared-\[...\]-path work on Windows (Jeremy Apthorp) [#21530](https://github.com/nodejs/node/pull/21530)
* [[`08c3f09f30`](https://github.com/nodejs/node/commit/08c3f09f30)] - **build**: add CONFIG\_FLAGS to with-code-cache target (Daniel Bevenius) [#22207](https://github.com/nodejs/node/pull/22207)
* [[`7135822386`](https://github.com/nodejs/node/commit/7135822386)] - **build**: make tools/doc/node\_modules non-phony (Daniel Bevenius) [#22189](https://github.com/nodejs/node/pull/22189)
* [[`d338d412cd`](https://github.com/nodejs/node/commit/d338d412cd)] - **build**: add crypto check to build targets (Daniel Bevenius) [#22148](https://github.com/nodejs/node/pull/22148)
* [[`d12c9f5af1`](https://github.com/nodejs/node/commit/d12c9f5af1)] - **build**: extract common parts from addon .buildstamp (Daniel Bevenius) [#22171](https://github.com/nodejs/node/pull/22171)
* [[`edaafcc3e2`](https://github.com/nodejs/node/commit/edaafcc3e2)] - **(SEMVER-MAJOR)** **build**: reset embedder string to "-node.0" (Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`58580e9ec2`](https://github.com/nodejs/node/commit/58580e9ec2)] - **(SEMVER-MINOR)** **crypto**: add better scrypt option aliases (Anna Henningsen) [#21525](https://github.com/nodejs/node/pull/21525)
* [[`9327a58984`](https://github.com/nodejs/node/commit/9327a58984)] - **crypto**: remove unused SSLWrap handle methods (Jon Moss) [#22216](https://github.com/nodejs/node/pull/22216)
* [[`bef02abb7d`](https://github.com/nodejs/node/commit/bef02abb7d)] - **crypto**: simplify state failure handling (Tobias Nießen) [#22131](https://github.com/nodejs/node/pull/22131)
* [[`3839ff0b7a`](https://github.com/nodejs/node/commit/3839ff0b7a)] - **crypto**: simplify Hmac::HmacUpdate (Tobias Nießen) [#22132](https://github.com/nodejs/node/pull/22132)
* [[`d005ae0628`](https://github.com/nodejs/node/commit/d005ae0628)] - **(SEMVER-MINOR)** **crypto**: add better scrypt option aliases (Anna Henningsen) [#21525](https://github.com/nodejs/node/pull/21525)
* [[`e1dcb795dd`](https://github.com/nodejs/node/commit/e1dcb795dd)] - **deps**: cherry-pick 09bca09 from upstream V8 (Matheus Marchini) [#22068](https://github.com/nodejs/node/pull/22068)
* [[`4e6be4c659`](https://github.com/nodejs/node/commit/4e6be4c659)] - **(SEMVER-MINOR)** **deps**: remove thread\_local to fix V8 compilation (Peter Marshall) [#21668](https://github.com/nodejs/node/pull/21668)
* [[`ce5cacda6e`](https://github.com/nodejs/node/commit/ce5cacda6e)] - **deps**: refactor v8.gyp (Michaël Zasso) [#22017](https://github.com/nodejs/node/pull/22017)
* [[`3cf809d4d6`](https://github.com/nodejs/node/commit/3cf809d4d6)] - **(SEMVER-MINOR)** **deps**: patch the V8 API to be backwards compatible with 6.7 (Peter Marshall) [#21668](https://github.com/nodejs/node/pull/21668)
* [[`48ab7dcc55`](https://github.com/nodejs/node/commit/48ab7dcc55)] - **deps**: cherry-pick 804a693 from upstream V8 (Matheus Marchini) [#21855](https://github.com/nodejs/node/pull/21855)
* [[`eb9850a64f`](https://github.com/nodejs/node/commit/eb9850a64f)] - **deps**: V8: Backport of 0dd3390 from upstream (James M Snell) [#21899](https://github.com/nodejs/node/pull/21899)
* [[`ada715f9db`](https://github.com/nodejs/node/commit/ada715f9db)] - **deps**: cherry-pick 907d7bc from upstream V8 (Michaël Zasso) [#21838](https://github.com/nodejs/node/pull/21838)
* [[`7299421bbc`](https://github.com/nodejs/node/commit/7299421bbc)] - **deps**: cherry-pick 2075910 from upstream V8 (Michaël Zasso) [#21838](https://github.com/nodejs/node/pull/21838)
* [[`c712e8c56c`](https://github.com/nodejs/node/commit/c712e8c56c)] - **deps**: cherry-pick 555c811 from upstream V8 (Anna Henningsen) [#21741](https://github.com/nodejs/node/pull/21741)
* [[`a9ec8884ff`](https://github.com/nodejs/node/commit/a9ec8884ff)] - **deps**: cherry-pick 477df06 from upstream v8 (Gus Caplan) [#21644](https://github.com/nodejs/node/pull/21644)
* [[`3afffebb5b`](https://github.com/nodejs/node/commit/3afffebb5b)] - **deps**: cherry-pick 70c4340 from upstream V8 (Matheus Marchini) [#21126](https://github.com/nodejs/node/pull/21126)
* [[`ffa835e3bb`](https://github.com/nodejs/node/commit/ffa835e3bb)] - **deps**: cherry-pick acc336c from upstream V8 (Matheus Marchini) [#21126](https://github.com/nodejs/node/pull/21126)
* [[`5b6c40116a`](https://github.com/nodejs/node/commit/5b6c40116a)] - **deps**: cherry-pick b20faff from upstream V8 (Matheus Marchini) [#21126](https://github.com/nodejs/node/pull/21126)
* [[`d9f566a7be`](https://github.com/nodejs/node/commit/d9f566a7be)] - **(SEMVER-MAJOR)** **deps**: cherry-pick aa6ce3e from upstream V8 (Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`d7af2fa9a7`](https://github.com/nodejs/node/commit/d7af2fa9a7)] - **deps**: cherry-pick 5dd3395 from upstream V8 (Matheus Marchini) [#21386](https://github.com/nodejs/node/pull/21386)
* [[`64e4e4eed9`](https://github.com/nodejs/node/commit/64e4e4eed9)] - **(SEMVER-MAJOR)** **deps**: update v8.gyp and run Torque (Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`2f6557390f`](https://github.com/nodejs/node/commit/2f6557390f)] - **(SEMVER-MAJOR)** **deps**: update V8 to 6.8.275.24 (Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`be888a8691`](https://github.com/nodejs/node/commit/be888a8691)] - **doc**: clarify http2 docs around class exports (James M Snell) [#22247](https://github.com/nodejs/node/pull/22247)
* [[`3ba7e2edfc`](https://github.com/nodejs/node/commit/3ba7e2edfc)] - **doc**: add multiple issue templates for GitHub (Tobias Nießen) [#22215](https://github.com/nodejs/node/pull/22215)
* [[`79b7a58671`](https://github.com/nodejs/node/commit/79b7a58671)] - **doc**: declare all parameter types (Sam Ruby) [#21782](https://github.com/nodejs/node/pull/21782)
* [[`bc6905bff6`](https://github.com/nodejs/node/commit/bc6905bff6)] - **doc**: add missing option for child\_process.spawnSync() (James Bromwell) [#22231](https://github.com/nodejs/node/pull/22231)
* [[`ab1e5d1152`](https://github.com/nodejs/node/commit/ab1e5d1152)] - **doc**: list encodings supported by buffer.transcode (James M Snell) [#22263](https://github.com/nodejs/node/pull/22263)
* [[`3814e467d3`](https://github.com/nodejs/node/commit/3814e467d3)] - **doc**: discuss special protocol handling (James M Snell) [#22261](https://github.com/nodejs/node/pull/22261)
* [[`99793b8806`](https://github.com/nodejs/node/commit/99793b8806)] - **doc**: replace \_WG\_ with \_team\_ (Rich Trott) [#22183](https://github.com/nodejs/node/pull/22183)
* [[`e313961e17`](https://github.com/nodejs/node/commit/e313961e17)] - **doc**: add subprocess.ref() and subprocess.unref() (Thomas Hunter II) [#22220](https://github.com/nodejs/node/pull/22220)
* [[`5ba56e5695`](https://github.com/nodejs/node/commit/5ba56e5695)] - **doc**: add gdams to collaborators (George Adams) [#22236](https://github.com/nodejs/node/pull/22236)
* [[`e80c646702`](https://github.com/nodejs/node/commit/e80c646702)] - **doc**: specify `options` parameter type in zlib.md (Vse Mozhet Byt) [#21920](https://github.com/nodejs/node/pull/21920)
...
* [[`fdeace6a02`](https://github.com/nodejs/node/commit/fdeace6a02)] - **(SEMVER-MINOR)** **fs**: implement mkdir recursive (mkdirp) (Benjamin Coe) [#21875](https://github.com/nodejs/node/pull/21875)
...
* [[`999f55a573`](https://github.com/nodejs/node/commit/999f55a573)] - **http2**: remove `streamError` from docs (James M Snell) [#22246](https://github.com/nodejs/node/pull/22246)
...
* [[`c96e552d4f`](https://github.com/nodejs/node/commit/c96e552d4f)] - **inspector**: add inspector\_protocol as a direct dependency (Andrey Lushnikov) [#21975](https://github.com/nodejs/node/pull/21975)
...
* [[`193a0480cd`](https://github.com/nodejs/node/commit/193a0480cd)] - **lib**: extract validateString validator (Jon Moss) [#22101](https://github.com/nodejs/node/pull/22101)
...
* [[`075995c8af`](https://github.com/nodejs/node/commit/075995c8af)] - **src**: yield empty maybes for failed AsyncWrap::MakeCallback calls (Anna Henningsen) [#22078](https://github.com/nodejs/node/pull/22078)
* [[`b7c872a58a`](https://github.com/nodejs/node/commit/b7c872a58a)] - **src**: remove unnecessary writes in tls\_wrap.cc (Anna Henningsen) [#21984](https://github.com/nodejs/node/pull/21984)
* [[`28d4d5fdb6`](https://github.com/nodejs/node/commit/28d4d5fdb6)] - **src**: avoid possible race during NodeBIO initialization (Anna Henningsen) [#21984](https://github.com/nodejs/node/pull/21984)
* [[`4590a1c3a2`](https://github.com/nodejs/node/commit/4590a1c3a2)] - **src**: use smart pointers for NodeBIO (Anna Henningsen) [#21984](https://github.com/nodejs/node/pull/21984)
* [[`5b7419bc4c`](https://github.com/nodejs/node/commit/5b7419bc4c)] - **src**: fix integer overflow in GetNow (Anatoli Papirovski) [#22214](https://github.com/nodejs/node/pull/22214)
* [[`b3eb10d9bd`](https://github.com/nodejs/node/commit/b3eb10d9bd)] - **src**: add READONLY\_STRING\_PROPERTY and simplify config (Jon Moss) [#22222](https://github.com/nodejs/node/pull/22222)
* [[`d13d60da12`](https://github.com/nodejs/node/commit/d13d60da12)] - **src**: fix up doc comment for experimental-worker bool (Anna Henningsen) [#22165](https://github.com/nodejs/node/pull/22165)
* [[`13e1d63801`](https://github.com/nodejs/node/commit/13e1d63801)] - **src**: remove calls to deprecated v8 functions (NumberValue) (Ujjwal Sharma) [#22094](https://github.com/nodejs/node/pull/22094)
* [[`9d801997c4`](https://github.com/nodejs/node/commit/9d801997c4)] - **src**: remove unused env-\>vm\_parsing\_context\_symbol (Jon Moss) [#22034](https://github.com/nodejs/node/pull/22034)
...
* [[`1c61205d73`](https://github.com/nodejs/node/commit/1c61205d73)] - **stream**: fix readable behavior for highWaterMark === 0 (Denys Otrishko) [#21690](https://github.com/nodejs/node/pull/21690)
* [[`4f6765f26e`](https://github.com/nodejs/node/commit/4f6765f26e)] - **test**: improve test coverage for comparisons (Ruben Bridgewater) [#22212](https://github.com/nodejs/node/pull/22212)
* [[`0385e09745`](https://github.com/nodejs/node/commit/0385e09745)] - **test**: remove common.fileExists() (Rich Trott) [#22151](https://github.com/nodejs/node/pull/22151)
* [[`6f28557a17`](https://github.com/nodejs/node/commit/6f28557a17)] - **test**: handle errors correctly in GC http test (Ouyang Yadong) [#22185](https://github.com/nodejs/node/pull/22185)
* [[`3666993e77`](https://github.com/nodejs/node/commit/3666993e77)] - **test**: remove second arg from assert.ifError() (Musa Hamwala) [#22190](https://github.com/nodejs/node/pull/22190)
* [[`3baeb82f43`](https://github.com/nodejs/node/commit/3baeb82f43)] - **test**: move require of https to after crypto check (Daniel Bevenius) [#22148](https://github.com/nodejs/node/pull/22148)
* [[`fcc150dbc1`](https://github.com/nodejs/node/commit/fcc150dbc1)] - **test**: move require of http2 to after crypto check (Daniel Bevenius) [#22148](https://github.com/nodejs/node/pull/22148)
* [[`95b2467d5f`](https://github.com/nodejs/node/commit/95b2467d5f)] - **test**: don't mask descriptor.enumerable (Thomas Leah) [#22172](https://github.com/nodejs/node/pull/22172)
* [[`6f47a84656`](https://github.com/nodejs/node/commit/6f47a84656)] - **test**: remove common.fileExists() (Richard Lau) [#22200](https://github.com/nodejs/node/pull/22200)
* [[`f1b34f99e0`](https://github.com/nodejs/node/commit/f1b34f99e0)] - **test**: remove unused argument in assertion (yahavfuchs) [#22113](https://github.com/nodejs/node/pull/22113)
* [[`9d85a059b7`](https://github.com/nodejs/node/commit/9d85a059b7)] - **test**: check arg type for dnsPromises.resolve (Masashi Hirano) [#22000](https://github.com/nodejs/node/pull/22000)
* [[`43c5455ac9`](https://github.com/nodejs/node/commit/43c5455ac9)] - **(SEMVER-MAJOR)** **test**: update postmortem metadata test (cjihrig) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`3175391e1d`](https://github.com/nodejs/node/commit/3175391e1d)] - **(SEMVER-MAJOR)** **test**: fix scriptParsed event expectations (Ingvar Stepanyan) [#21079](https://github.com/nodejs/node/pull/21079)
* [[`a6b9ee9c89`](https://github.com/nodejs/node/commit/a6b9ee9c89)] - **test**: update certificates and private keys (Fedor Indutny) [#22184](https://github.com/nodejs/node/pull/22184)
...
* [[`94746d6a47`](https://github.com/nodejs/node/commit/94746d6a47)] - **(SEMVER-MAJOR)** **test**: remove outdated, non-functioning test (Anatoli Papirovski) [#20894](https://github.com/nodejs/node/pull/20894)
...
* [[`97ac2b7dc5`](https://github.com/nodejs/node/commit/97ac2b7dc5)] - **test,doc**: adjust markdown table for linting (Rich Trott) [#22221](https://github.com/nodejs/node/pull/22221)
* [[`9e11235422`](https://github.com/nodejs/node/commit/9e11235422)] - **test,doc**: adjust async-hooks coverage doc for lint (Rich Trott) [#22221](https://github.com/nodejs/node/pull/22221)
* [[`b26c446ebe`](https://github.com/nodejs/node/commit/b26c446ebe)] - **test,doc**: wrap common module md doc at 80 chars (Rich Trott) [#22221](https://github.com/nodejs/node/pull/22221)
* [[`3ba3d020cd`](https://github.com/nodejs/node/commit/3ba3d020cd)] - **test,doc**: fix lint error in test fixtures (Rich Trott) [#22221](https://github.com/nodejs/node/pull/22221)
* [[`7ca93e2c6e`](https://github.com/nodejs/node/commit/7ca93e2c6e)] - **tls**: change var to const (Eugen Cazacu) [#22219](https://github.com/nodejs/node/pull/22219)
* [[`271cc12b2a`](https://github.com/nodejs/node/commit/271cc12b2a)] - **tls**: remove SLAB\_BUFFER\_SIZE (Anatoli Papirovski) [#21199](https://github.com/nodejs/node/pull/21199)
* [[`b1a9cf756b`](https://github.com/nodejs/node/commit/b1a9cf756b)] - **tls**: preallocate SSL cipher array (Tobias Nießen) [#22136](https://github.com/nodejs/node/pull/22136)
* [[`f0c71d7361`](https://github.com/nodejs/node/commit/f0c71d7361)] - **tools**: add no-misleading-character-class ESLint rule (Vse Mozhet Byt) [#22278](https://github.com/nodejs/node/pull/22278)
* [[`f68b165532`](https://github.com/nodejs/node/commit/f68b165532)] - **tools**: do not autolink section to itself (Vse Mozhet Byt) [#22138](https://github.com/nodejs/node/pull/22138)
* [[`e152cf7209`](https://github.com/nodejs/node/commit/e152cf7209)] - **tools**: update ESLint to 5.3.0 (Rich Trott) [#22134](https://github.com/nodejs/node/pull/22134)
* [[`44edfa436c`](https://github.com/nodejs/node/commit/44edfa436c)] - **tools**: convert addon-verify to remark (Sam Ruby) [#21978](https://github.com/nodejs/node/pull/21978)
...
* [[`9aa72a4aa1`](https://github.com/nodejs/node/commit/9aa72a4aa1)] - **tools,build**: apply markdown linting to test dir (Rich Trott) [#22221](https://github.com/nodejs/node/pull/22221)
* [[`fd318e70b5`](https://github.com/nodejs/node/commit/fd318e70b5)] - **trace_events**: add node.promises category, rejection counter (James M Snell) [#22124](https://github.com/nodejs/node/pull/22124)
* [[`df087cf09e`](https://github.com/nodejs/node/commit/df087cf09e)] - **util**: improve display of iterators and weak entries (Ruben Bridgewater) [#20961](https://github.com/nodejs/node/pull/20961)
* [[`c3365dbbf5`](https://github.com/nodejs/node/commit/c3365dbbf5)] - **util,assert**: fix boxed primitives bug (Ruben Bridgewater) [#22243](https://github.com/nodejs/node/pull/22243)
* [[`561b1f51df`](https://github.com/nodejs/node/commit/561b1f51df)] - **worker**: fix deadlock when calling terminate from exit handler (Anna Henningsen) [#22073](https://github.com/nodejs/node/pull/22073)
* [[`00b0a62988`](https://github.com/nodejs/node/commit/00b0a62988)] - **zlib**: remove unused parameters (MaleDong) [#22115](https://github.com/nodejs/node/pull/22115)
